...
try:
    ...
    if response.status_code == 200:
        data = response.json()
        print("   SUCCESS: Main endpoint accessible")
...
print("\n" + "="*70)
print("SERVER STATUS:")
print("SUCCESS: Backend API is running on http://127.0.0.1:8000")
print("SUCCESS: RAG Chatbot is ready with OpenAI integration")
print("SUCCESS: Qdrant Vector Storage is configured")
print("SUCCESS: Neon Postgres is connected")
print("="*70)
