...
if not GEMINI_API_KEY:
    ...
    # For Hugging Face Spaces and development, allow the app to start without the API key
    # and handle the error gracefully in the endpoints
    print("Running without GEMINI_API_KEY - chatbot will be disabled until API key is set")
    GEMINI_API_KEY = ""
